...
import '../../services/auth_servicesp.dart';
import 'Login.dart';
...
class _SignUpViewState extends State<SignUpView> {
  ...
  final _policestationnoController = TextEditingController();
  ...
  Future<void> _submitform() async {
    if (_formkey.currentState!.validate()) {
      ...
      var data = {
        ...
        "station": _policestationnoController.text,
      ...
      await authservice.createpolices(data, context);
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 16.0),
                  _buildTextField(_policestationnoController, 'policestation_no', Icons.person, TextInputType.name),
                  SizedBox(height: 16.0),
                  _buildTextField(_localityController, 'locality', Icons.phone, TextInputType.phone),
                  SizedBox(height: 16.0),
                  _buildTextField(_cityController, 'City', Icons.location_city, TextInputType.text),
                  SizedBox(height: 16.0),
                  _buildTextField(lat, 'Latitude', Icons.location_city, TextInputType.text),

                  SizedBox(height: 16.0),
                  _buildTextField(lon, 'Longitude', Icons.location_city, TextInputType.text),
